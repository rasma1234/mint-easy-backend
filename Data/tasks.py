...
@shared_task
def fetch_forex_data1_15(api_key='25979cee57c94c3d830d9ec7d81b66b4', symbol='USD/CAD', interval='15min', outputsize=5000):
    api_endpoint = f'https://api.twelvedata.com/time_series?symbol={symbol}&interval={interval}&apikey={api_key}&outputsize={outputsize}'
    try:
        response = requests.get(api_endpoint)
        forex_data_list = response.json()
...
@shared_task
def fetch_forex_data2_15(api_key='a2375ed749b24365b68f80f615205219', symbol='USD/JPY', interval='15min', outputsize=5000):
    api_endpoint = f'https://api.twelvedata.com/time_series?symbol={symbol}&interval={interval}&apikey={api_key}&outputsize={outputsize}'
    try:
        response = requests.get(api_endpoint)
        forex_data_list = response.json()
...
@shared_task
def fetch_forex_data3_15(api_key='01f82aa7a681472d86ddf857caa90c0a', symbol='USD/CHF', interval='15min', outputsize=5000):
    api_endpoint = f'https://api.twelvedata.com/time_series?symbol={symbol}&interval={interval}&apikey={api_key}&outputsize={outputsize}'
    try:
        response = requests.get(api_endpoint)
        forex_data_list = response.json()
...
@shared_task
def fetch_forex_data4_15(api_key='87dfcae512444ed194e2052f6ac353ca', symbol='GBP/USD', interval='15min', outputsize=5000):
    api_endpoint = f'https://api.twelvedata.com/time_series?symbol={symbol}&interval={interval}&apikey={api_key}&outputsize={outputsize}'
    try:
        response = requests.get(api_endpoint)
        forex_data_list = response.json()
...
@shared_task
def fetch_crypto_data_15(api_key='8ee57089310043829e1143076678af65', symbol='BTC/USD', interval='15min', outputsize=5000):
    api_endpoint = f'https://api.twelvedata.com/time_series?symbol={symbol}&interval={interval}&apikey={api_key}&outputsize={outputsize}'
    try:
        response = requests.get(api_endpoint)
        crypto_data_list = response.json()
...
@shared_task
def fetch_crypto_data1_15(api_key='5607c990906143b4a804c8adedfcb092', symbol='ETH/USD', interval='15min', outputsize=5000):
    api_endpoint = f'https://api.twelvedata.com/time_series?symbol={symbol}&interval={interval}&apikey={api_key}&outputsize={outputsize}'
    try:
        response = requests.get(api_endpoint)
        crypto_data_list = response.json()
...
@shared_task
def fetch_stock_data_15(api_key='1ebe6bd6682f44f5bbee1c74ba7a18cc', symbol='AAPL', interval='15min', outputsize=5000):
    api_endpoint = f'https://api.twelvedata.com/time_series?symbol={symbol}&interval={interval}&apikey={api_key}&outputsize={outputsize}'
    try:
        response = requests.get(api_endpoint)
        stock_data_list = response.json()
...
@shared_task
def fetch_stock_data1_15(api_key='d6d2d7367d1a439da36736e672b0f8f0', symbol='TSLA', interval='15min', outputsize=5000):
    api_endpoint = f'https://api.twelvedata.com/time_series?symbol={symbol}&interval={interval}&apikey={api_key}&outputsize={outputsize}'
    try:
        response = requests.get(api_endpoint)
        stock_data_list = response.json()
...
@shared_task
def fetch_stock_data2_15(api_key='5b4c67e251bc404c8c072f185cd34e6f', symbol='AMZN', interval='15min', outputsize=5000):
    api_endpoint = f'https://api.twelvedata.com/time_series?symbol={symbol}&interval={interval}&apikey={api_key}&outputsize={outputsize}'
    try:
        response = requests.get(api_endpoint)
        stock_data_list = response.json()
...
@shared_task
def fetch_stock_data3_15(api_key='449660e5255c40ea9350b53b45e6addb', symbol='MSFT', interval='15min', outputsize=5000):
    api_endpoint = f'https://api.twelvedata.com/time_series?symbol={symbol}&interval={interval}&apikey={api_key}&outputsize={outputsize}'
    try:
        response = requests.get(api_endpoint)
        stock_data_list = response.json()
...
@shared_task
def fetch_stock_data4_15(api_key='e86546bfa67a445c977012a16c2e8f12', symbol='JPM', interval='15min', outputsize=5000):
    api_endpoint = f'https://api.twelvedata.com/time_series?symbol={symbol}&interval={interval}&apikey={api_key}&outputsize={outputsize}'
    try:
        response = requests.get(api_endpoint)
        stock_data_list = response.json()
